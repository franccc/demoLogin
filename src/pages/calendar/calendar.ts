...
export class CalendarPage {
  ...
  validation:any = {};
  CLIENT_ID = '834168230719-tcrp9gh084um0g9th8vlk9l7svdu9oel.apps.googleusercontent.com'; // Client ID of your google console project
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
              ...
              public inAppBrowserEvent: InAppBrowserEvent ) {
  }
  ...
  sendInvite() {
      ...
      var browserRef = InAppBrowser.call('https://accounts.google.com/o/oauth2/auth?client_id=' + this.CLIENT_ID + '&redirect_uri=' + this.REDIRECTURL + '&scope=https://www.googleapis.com/auth/calendar&approval_prompt=force&response_type=token', '_blank', 'location=no');         
